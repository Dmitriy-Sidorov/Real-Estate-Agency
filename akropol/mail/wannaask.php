...
function isPhone($phone) {
	return(preg_match("/^\+?\d+([\(\s\-]?\d+[\)\s\-]?[\d\s\-]+)?$/i",$phone));
}
function isName($name) {
	return(preg_match("/^[а-яА-Я]{30}|[a-zA-Z][\d\s\]{30}$/",$name));
}
...
$e_content .= "Message: $question" . PHP_EOL . PHP_EOL;
$e_content .= "Page: $page" . PHP_EOL . PHP_EOL;

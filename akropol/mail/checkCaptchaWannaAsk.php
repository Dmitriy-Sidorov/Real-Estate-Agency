<?php	
  ...
  $data['result']='success';
	...
	$page = "";
  // получаем page
  if (isset($_POST['wafPageUrl'])) {
    $page = $_POST['wafPageUrl'];
    
  }
	if (isset($_POST['wafQuestion'])) {
    $question = $_POST['wafQuestion'];
  ...
  $output .= '<p><b>Вопрос:</b> ' . $question . '</p>';
  $output .= '<p><b>Страница:</b> ' . $page . '</p>';
  ...
  $mail->isHTML(true);
  $mail->Subject   = 'Сообщение с формы "Задать вопрос"';
  $mail->Body      = $output;

<?php	
  ...
  $output .= '<p><b>Предлагаемая цена:</b> ' . $price . '</p>';
  $output .= '<p><b>Объект:</b> ' . $subject . '</p>';
  $output .= '<p><b>Страница:</b> ' . $pagelink . '</p>';
  ...
  $mail->isHTML(true);
  $mail->Subject   = 'Сообщение с формы "Предложить свою цену"';
  $mail->Body      = $output;

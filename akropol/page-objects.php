<?
/**
 * Template Name: Оъекты недвижимости
 * @package WordPress
 */
        ...
        <div class="row">
          <div class="navObjects">
            ...
            <div class="newCategory">
              <ul>
                <li>
                  <a href="/object_category/arenda/">Аренда</a>
                </li>
                <li>
                  <a href="/object_category/sale/">Продажа</a>
                </li>
              </ul>
            </div>
          </div>
                    ...
                    <div class="property-info">
						<?php
                      		if (!empty(get_field("price"))) {
                        		echo '<div class="price-property"><div class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer"><span itemprop="price">'.$ot . number_format(get_field("price"), 0, ',', ' ') . '</span><strong itemprop="priceCurrency" content="RUB">руб.</strong></div>';
						  		
								echo '<div class="price price-square">
									<span class="">'
										.number_format(round(get_field("price") / get_field("square")), 0, ',', ' ') .
									'</span>
									<strong>за м<sup>2</sup></strong>
								</div></div>'; 
							} ?>
                      <h3>
                        <a itemprop="name"
